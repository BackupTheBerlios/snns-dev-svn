...
static PyMethodDef MylibMethods[] = {
     ...
     {"getFirstSuccUnit",snns_getFirstSuccUnit,METH_O,
      "getFirstSuccUnit(unit number) -> (unit number, connection strength)\n\n"
      "Gets unit number and connection strength of the first successor of\n"
       "the given unit."},
     ...
     {"DefTrainSubPat",snns_DefTrainSubPat, METH_VARARGS,
      ...
      "insize, outsize, instep, outstep are sequences for the subpattern\n"
     ...
     {"DefShowSubPat",snns_DefShowSubPat, METH_VARARGS,
      ...
      "insize, outsize, inpos, outpos are sequences for the subpattern\n"
